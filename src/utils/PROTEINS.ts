...
export const PROTEINS: { [type: string]: Protein[] } = {
  viruses: [
    ...
    // },
    {
      ...
      interactive: true,
      authors:
        "Sun, J., Liu, C., Peng, R., Zhang, F.K., Tong, Z., Liu, S., Shi, Y., Zhao, Z., Zeng, W.B., Gao, G.F., Shen, H.J., Yang, X., Luo, M., Qi, J., Wang, P.",
      pubmedAbstract:
    ...
    },
    {
      ...
      interactive: true,
      authors:
        "Teoh, E.P., Kukkaro, P., Teo, E.W., Lim, A.P., Tan, T.T., Yip, A., Schul, W., Aung, M., Kostyuchenko, V.A., Leo, Y.S., Chan, S.H., Smith, K.G., Chan, A.H., Zou, G., Ooi, E.E., Kemeny, D.M., Tan, G.K., Ng, J.K., Ng, M.L., Alonso, S., Fisher, D., Shi, P.Y., Hanson, B.J., Lok, S.M., Macary, P.A.",
      pubmedAbstract:
    ...
    },
    {
      ...
      interactive: true,
      authors:
        "Cardone, G., Moyer, A.L., Cheng, N., Thompson, C.D., Dvoretzky, I., Lowy, D.R., Schiller, J.T., Steven, A.C., Buck, C.B., Trus, B.L.",
      pubmedAbstract:
  ...
  antibodies: [
    ...
    {
      Component: Antibody_hiv_10,
      name: "anti-Faustovirus Antibody",
      type: PROTEIN_TYPES.antibody,
      virusTarget: "Faustovirus",
      PDBUrl: "https://www.rcsb.org/structure/3RPI",
      mass: 96.41,
      atomCount: 6650,
      radius: 50,
    ...
    },
    {
      ...
      interactive: true,
      authors:
        "Lee, C.C., Lin, L.L., Chan, W.E., Ko, T.P., Lai, J.S., Wang, A.H.J.",
      pubmedAbstract:
  ...
  nanotech: [
    ...
    },
    {
      ...
      interactive: true,
      authors:
        "Hao, Y., Kristiansen, M., Sha, R., Birktoft, J.J., Hernandez, C., Mao, C., Seeman, N.C.",
      pubmedAbstract:
